...
var sharingmanager = {
    shareViaEmail: function (filePath) {
        ...
        window.plugins.socialsharing.shareViaEmail(
                'Sharing CSi Section Report', // can contain HTML tags, but support on Android is rather limited:  http://stackoverflow.com/questions/15136480/how-to-send-html-content-with-image-through-android-default-email-client
                'CSiSections',
...
//            alert(window.plugins.socialsharing);
            ...
            common.ShowMessage($TITLE,"Error occurred while sharing report:"+ e.toString());
        }
    ...
    onSuccess: function ()
    {
        common.ShowMessage($TITLE, "Report has been successfully shared.");
    },
    onError: function (error)
    {
        //alert("Error");
        common.ShowMessage($TITLE, "Error occurred while sharing report:" +error);
